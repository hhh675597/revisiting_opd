# export RAY_ADDRESS="172.31.66.108:6379"
# 清除冲突的环境变量
unset ROCR_VISIBLE_DEVICES
echo "设置的amd GPU: $ROCR_VISIBLE_DEVICES"
export CUDA_VISIBLE_DEVICES=0,1,2,3
# export HF_ENDPOINT=https://hf-mirror.com
echo "设置的GPU: $CUDA_VISIBLE_DEVICES"
export RAY_MAX_WORKER_PROCESSES=64
# export WANDB_MODE=offline
export RAY_worker_register_timeout_seconds=600
# srun --jobid=7682 --overlap --pty /bin/bash
set -x
ENGINE=${1:-vllm}
