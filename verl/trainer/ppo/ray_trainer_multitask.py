...
def compute_advantage(data: DataProto, adv_estimator, gamma=0.0, lam=1.0, num_repeat=1, multi_turn=False, norm_adv_by_std_in_grpo=True, step_advantage_w=1.0, gigpo_mode="mean_std_norm", gigpo_enable_similarity=False, gigpo_similarity_thresh=0.95, reward_weight=0.0, tokenizer=None, **kwargs):
